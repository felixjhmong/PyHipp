...
<<<<<<< HEAD
        plotOpts = {'PlotType': DPT.objects.ExclusiveOptions(['Channel', 'Array'], 0), 'LabelsOff': False, 'TitleOff': False, 'TicksOff': False}
=======
...
<<<<<<< HEAD
        ...
        #     title_local = self.channel_filename[7:]
        #     plt.pyplot.title(title_local)
